    ...
    module G1804
      ...
      LOCATION_NAMES = {
        ...
        HEXES = {
          ...
          white: {
            %w[C4 C12 ] => 'town',
            %w[E10 G14 J9] => 'town=revenue:0;town=revenue:0',
            ...
            %w[B7 B11 E2 E4 F7 G12 H15 I12 I16 J13] => 'city',
            %w[B9 C6 C8 D3 D5 D9 D11 E6 E8 F3 F5 G16 H9 H11 H13 H17 I10 I14 J11 J15 K8 K10 K12] => 'blank',
            ['D7'] => 'city=revenue:0;label=B',
          },

          gray: {
            ['B19'] => 'city=revenue:30;path=a:0,b:_0;path=a:1,b:_0',
            ['I18'] => 'town=revenue:10;path=a:0,b:_0;path=a:2,b:_0',
